                ...
                <>
                  <Disclosure.Button
                    className={classNames(
                      "bg-green-500 text-gray-700 flex item-center w-full text-left rounded-md p-2 gap-x-3 text-sm leading-6 font-semibold",
                      open
                  ...
                  >
                    <ChevronRightIcon
                      ...
                      aria-hidden="true"
                    />
                    <button><VscFileSubmodule></VscFileSubmodule></button>
                    <span>Menu</span>{" "}
                    <button
                      className="text-xl  "
