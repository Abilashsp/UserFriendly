        ...
        {activeButton === 1 && (
          <form className="mb-6" onSubmit={handleSubmit}>
            ...
            >
             ...
             {activeButton === 2 && (
          <div >
            <Fileopener activeButton={activeButton} setimgs={setimgs} img={img} handelimage={handelimage}  setCenterbarValues={ setCenterbarValues} textid={ textid}  setactivebutton={ setactivebutton} />
          </div>
        )}

{activeButton === 3 && (
          <div >
                  <CSVTable  setCsvData={setCsvData}
 csvData={csvData}  setactivebutton={ setactivebutton}/>
          </div>
        )}
