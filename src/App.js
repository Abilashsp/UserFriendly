...
function App() {
  ...
  const textcolor = [
    { id: "text-color-black", icon: <BiFontColor />, color: "text-slate-900", iconcolor: "back" },
    ...
    { id: "text-color-green", icon: <BiFontColor />, color: "text-green-600" , iconcolor: "green"},
    { id: "text-color-red", icon: <BiFontColor />, color: "text-red-600", iconcolor: "red" },
    { id: "text-color-brown", icon: <BiFontColor />, color: "text-amber-800", iconcolor: "brown" },
    { id: "text-color-orange", icon: <BiFontColor />, color: "text-orange-600" , iconcolor: "orange"},
    { id: "text-color-gray", icon: <BiFontColor />, color: "text-gray-600" , iconcolor: "gray"},
  ];
  ...
  const textbackgroundcolor = [
    ...
    { id: "text-bg-LightBlue", icon: <MdFontDownload />, color: "bg-blue-200", iconcolor: "lighblue" },
